...
# v21: dfp环境
def radio_competition_v21_env():
    """Start up a team radio config with the default settings."""
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = '_pommerman._envs.v21:Pomme'
    env_id = 'PommeRadioCompetition-v21'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
        'num_rigid': constants.NUM_RIGID,
...
def maze_v1_env():
    ...
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = '_pommerman._envs.maze_v1:Pomme'
    env_id = 'maze-v1'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
...
def maze_v2_env():
    ...
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = '_pommerman._envs.maze_v2:Pomme'
    env_id = 'maze-v2'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
...
def maze_v3_env():
    ...
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = '_pommerman._envs.maze_v3:Pomme'
    env_id = 'maze-v3'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
...
def maze_v4_env():
    ...
    env = envs.v2.Pomme
    game_type = constants.GameType.TeamRadio
    env_entry_point = '_pommerman._envs.maze_v4:Pomme'
    env_id = 'maze-v4'
    env_kwargs = {
        'game_type': game_type,
        'board_size': constants.BOARD_SIZE,
